...
type SimpleBankClient interface {
	...
	LoginUser(ctx context.Context, in *LoginUserRequest, opts ...grpc.CallOption) (*BaseResponse, error)
...
func (c *simpleBankClient) LoginUser(ctx context.Context, in *LoginUserRequest, opts ...grpc.CallOption) (*BaseResponse, error) {
...
type SimpleBankServer interface {
	...
	LoginUser(context.Context, *LoginUserRequest) (*BaseResponse, error)
...
func (UnimplementedSimpleBankServer) LoginUser(context.Context, *LoginUserRequest) (*BaseResponse, error) {
